...
\begin{table}[htbp]
  ...
  \label{tab:unit_root}
  \begin{tabular}{lccrrcrrr}
    \toprule
    \multirow{2}{*}{变量} & \multirow{2}{*}{检验方法} & \multirow{2}{*}{差分阶数} & \multirow{2}{*}{$t$ 统计量} & \multirow{2}{*}{$p$ 值} & \multirow{2}{*}{AIC} & \multicolumn{3}{c}{临界值} \\
    \cmidrule(lr){7-9}
    & & & & & & 1\% & 5\% & 10\% \\
    \midrule
    \multirow{3}{*}{对数收益率} & \multirow{3}{*}{ADF} & 0 & -12.6088 & 1.6733e-23*** & 22696.4184 & -3.4314 & -2.8620 & -2.5670 \\
     &  & 1 & -23.7607 & 0.0000e+00*** & 22849.3615 & -3.4314 & -2.8620 & -2.5670 \\
     &  & 2 & -28.6333 & 0.0000e+00*** & 23352.5152 & -3.4314 & -2.8620 & -2.5670 \\
    \multirow{3}{*}{对数收益率} & \multirow{3}{*}{KPSS} & 0 & 0.0552 & 1.0000e-01 & -- & 0.7390 & 0.4630 & 0.3470 \\
     &  & 1 & 0.0465 & 1.0000e-01 & -- & 0.7390 & 0.4630 & 0.3470 \\
     &  & 2 & 0.0165 & 1.0000e-01 & -- & 0.7390 & 0.4630 & 0.3470 \\
    \bottomrule
  \end{tabular}
\end{table}
