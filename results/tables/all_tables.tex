...
\begin{table}[htbp]
  ...
  \begin{tabular}{lccrrcrrr}
    ...
    & & & & & & 1\% & 5\% & 10\% \\
    \midrule
    \multirow{1}{*}{对数收益率} & \multirow{1}{*}{ADF} & 0 & -12.6088 & 1.6733e-23*** & 22696.4184 & -3.4314 & -2.8620 & -2.5670 \\
    \multirow{1}{*}{对数收益率} & \multirow{1}{*}{KPSS} & 0 & 0.0552 & 1.0000e-01 & -- & 0.7390 & 0.4630 & 0.3470 \\
    \bottomrule
  \end{tabular}
\end{table}
